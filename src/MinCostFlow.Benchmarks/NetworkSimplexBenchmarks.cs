...
public class NetworkSimplexBenchmarks
{
    ...
    private readonly Dictionary<string, MinCostFlowProblem> _problemCache = [];
    
    // Lists of problems by category for benchmarking
    private List<MinCostFlowProblem> _smallProblems = [];
    private List<MinCostFlowProblem> _mediumProblems = [];
    private List<MinCostFlowProblem> _largeProblems = [];
    private List<MinCostFlowProblem> _generatedProblems = [];
    ...
    private static SolverStatus SolveProblem(MinCostFlowProblem problem)
    {
