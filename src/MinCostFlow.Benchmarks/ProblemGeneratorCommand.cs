    ...
    public static class ProblemGeneratorCommand
    {
        ...
        private static void GenerateAssignmentProblem(string[] args)
        {
            ...
            try
            {
                ...
                // Save to resources
                var resourceDir = GetResourceDirectory(category);
        ...
        private static string GetResourceDirectory(string category)
        {
            ...
            var resourceDir = Path.Combine(projectRoot, "Resources", category);
