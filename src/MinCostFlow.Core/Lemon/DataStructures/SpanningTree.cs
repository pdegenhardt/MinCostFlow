...
#pragma warning restore CA1707 // Identifiers should not contain underscores
    ...
    public readonly int FindJoinNode(int u, int v)
    {
        while (u != v)
        {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool IsInSubtree(int u, int v)
    {
    ...
    /// </summary>
    public readonly void InitializeAsStart(int root)
    {
        // Set root
        Parent[root] = -1;
        Pred[root] = -1;
    ...
    /// </summary>
    public readonly bool Equals(SpanningTree other)
    {
    ...
    /// </summary>
    public override readonly bool Equals(object? obj) => obj is SpanningTree other && Equals(other);
