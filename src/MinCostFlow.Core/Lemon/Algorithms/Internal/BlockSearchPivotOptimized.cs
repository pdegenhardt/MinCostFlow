...
namespace MinCostFlow.Core.Lemon.Algorithms.Internal;
...
/// </summary>
internal sealed unsafe class FirstEligiblePivotOptimized(NetworkSimplex ns,
    long* costPtr, long* piPtr, int* sourcePtr, int* targetPtr, sbyte* statePtr)
{
    ...
    // Pinned arrays for unsafe access
    private readonly long* _costPtr = costPtr;
    private readonly long* _piPtr = piPtr;
    private readonly int* _sourcePtr = sourcePtr;
    private readonly int* _targetPtr = targetPtr;
    private readonly sbyte* _statePtr = statePtr;
...
/// </summary>
internal sealed unsafe class BestEligiblePivotOptimized(NetworkSimplex ns,
    long* costPtr, long* piPtr, int* sourcePtr, int* targetPtr, sbyte* statePtr)
{
    private readonly NetworkSimplex _ns = ns;
