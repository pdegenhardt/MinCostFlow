...
namespace MinCostFlow.Core.Validation;
...
public class SolutionValidator
{
    ...
    private readonly NetworkSimplex _solver;

    public SolutionValidator(IGraph graph, NetworkSimplex solver)
    {
        _graph = graph;
        _solver = solver;
    }
...
public class ValidationResult
{
    ...
    public List<(int arcId, int source, int target, long flow, long cost)> ArcFlows { get; } = new();
}