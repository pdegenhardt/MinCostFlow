...
namespace MinCostFlow.Problems.Sets
{
    ...
    public class DynamicProblems
    {
        ...
        public DynamicProblems(EmbeddedResourceLoader? loader = null)
        {
            _loader = loader ?? new EmbeddedResourceLoader();
        }
        ...
        /// </summary>
        private string DetermineCategory(string resourceName)
        {
