...
public class ProblemRepository
{
    ...
    private readonly List<IProblemLoader> _loaders = [];
    ...
    /// </summary>
    public static MinCostFlowProblem LoadFromStream(Stream stream, string format = "dimacs")
    {
    ...
    public static Dictionary<string, string> GetAvailableEmbeddedProblems()
    {
        var embeddedLoader = new EmbeddedResourceLoader();
        ...
        foreach (var resource in resources)
        {
            ...
            if (parts.Length >= 3)
            {
                var category = parts[^3]; // e.g., "small", "dimacs"
                var name = parts[^2];     // e.g., "path_5node"
